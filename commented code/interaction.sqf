			...
			{   
				if(_actionModel == _array select _i)then																				// cursor is type of array
				{
					...
					if(getact == 1)then{}else{																		// which model from array has been found
						...
						ahction = player addAction["Look","look.sqf"];																			// add the action to the player
