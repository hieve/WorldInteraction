...
systemchat format ["Init with:%1 Objects",(str _arraylength)];
if((!isNull cursorObject) && (_player distance cursorObject < 5))then{
	...
	for "_i" from 0 to _arraylength do  					
		{   
			...
			{ 
				...
				_detect = true;
				hint str "adding to actionmenu";
				action = player addAction["Look", execVM "look.sqf"]; 
			};									
		};
}
else
